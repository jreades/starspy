...
from stars.visualization.mapModels import CanvasModel
from stars.visualization.wxStars.wxCanvas import wxCanvas
...
class MapFrameApp(wx.App):
    def OnInit(self):
        ...
        mdl = CanvasModel([layer2])
        panel = wxCanvas(self.frame,mdl)
        self.frame._mgr.AddPane(panel, wx.RIGHT)
        mdl2 = CanvasModel([layer3])
        panel2 = wxCanvas(self.frame,mdl2)
        self.frame._mgr.AddPane(panel2, wx.RIGHT)
