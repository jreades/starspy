...
class WeightsMapFrame(wx.Frame):      
    def __init__(self,parent=None,size=(400,400), style=wx.DEFAULT_FRAME_STYLE, geo=None, w=None):          
...
class WeightsMapApp(wx.App):      
    ...
    def OnInit(self):          
        ...
        self.frame = WeightsMapFrame(None,size=(400,400),geo=self.geo,w=self.w)          
