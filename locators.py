...
class PolygonLocator:
    ...
    def overlapping(self, query_rectangle):
        ...
        >>> len(res)
        3
        >>> qr = Rectangle(4, 3, 4, 3)
        >>> res = pl.overlapping( qr )
        >>> len(res)
        1
        >>> qr = Rectangle(4.0, 3.0, 4.0, 3.0)
        >>> res = pl.overlapping( qr )
        >>> len(res)
        1
        >>> qr = Rectangle(4, 3, 4.01, 3.01)
        >>> res = pl.overlapping( qr )
        >>> len(res)
        1
        >>> qr = Rectangle(4, 5, 4, 5)
        >>> res = pl.overlapping( qr )
        >>> len(res)
        2
        >>> qr = Rectangle(4.0, 3.0, 4.0, 3.0)
        ...
        >>> len(res)
        1
        >>> qr = Rectangle(4.0, 5.0, 4.0, 5.01)
        >>> res = pl.overlapping( qr )
        >>> len(res)
        1
        >>> qr = Rectangle(4, 5, 4.01, 5.01)
        >>> res = pl.overlapping( qr )
        >>> len(res)
        1
        >>> qr = Rectangle(3.99, 4.99, 4, 5)
        >>> res = pl.overlapping( qr )
        >>> len(res)
        2
